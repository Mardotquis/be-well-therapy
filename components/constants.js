...
export const services = [
  {
    ...
    smBackgroundImg: '/img/home/small-girl-sm.png',
    rectangleBackgroundImg: '/img/our-services/small-girl-rect.png',
    smRectangleBackgroundImg: '/img/our-services/small-girl-sm-rect.png',
  ...
  },
  {
    ...
    modalInfo: {
      mainSentence: 'Licensed professionals treat mental and emotional concerns and disorders through techniques designed to encourage communication of conflicts, insight into problems, and with the aim to improve the individual’s well-being.',
      listItemsHeading: 'Treatment specialties:',
  ...
  },
  {
    ...
    shortName: 'school-counseling',
    rectangleBackgroundImg: '/img/our-services/school-rect.png',
    smRectangleBackgroundImg: '/img/our-services/school-sm-rect.png',
  ...
  },
  {
    ...
    modalInfo: {
      mainSentence: 'Our Level III Residential Treatment Program (therapeutic group home model) offers 24-hour supervised care for adolescents who need structured behavioral health support outside the home. Our program includes clinical assessments, individualized treatment plans, weekly outpatient individual, family and group therapy sessions, skill-building groups, equine-assisted services and coordinated care with families, schools, and referral partners. We focus on stabilization, accountability, emotional regulation, and transition readiness through consistent structure and therapeutic engagement.',
